# Archived BBEdit LaTeX handoff — through 2026-09-24

Historical record only. Status statements and task lists below are superseded by
[the current handoff](../HANDOFF.md); do not treat old pending items as new work.
