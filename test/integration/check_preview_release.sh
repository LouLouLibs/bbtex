...
for resource in with-preview-lock.pl preview-save-hook.applescript snippet-window.applescript install-preview-save-hook.py install-preview-service.py; do
